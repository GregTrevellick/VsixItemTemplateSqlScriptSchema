...
.\VsixPublisher.exe publish -payload "..\..\..\..\..\..\..\VsixItemTemplateSqlScriptSchema\Src\ItemTemplate.VsixPackage\bin\Debug\ItemTemplate.VsixPackage.vsix" -publishManifest "..\..\..\..\..\..\..\VsixItemTemplateSqlScriptSchema\Src\VsmpPublish.json" -personalAccessToken "pat"
